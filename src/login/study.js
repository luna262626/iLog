      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={styles.loginScreenContainer}>
          <View style={styles.loginFormView}>
            ...
            <TextInput placeholder="Amount of tasks done" placeholderColor="#c4c3cb" style={styles.loginFormTextInput} secureTextEntry={true}/>
            <TextInput placeholder="Amount of subjects done" placeholderColor="#c4c3cb" style={styles.loginFormTextInput} secureTextEntry={true}/>
